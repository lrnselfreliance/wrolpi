...
# NOTE: Inventory no longer supports config backup/restore — it is a config-only MultiFileConfig
# (config/inventory/*.yaml) and was removed from DB_CONFIG_FILE_NAMES.  Its previous backup-import tests
# (TestInventoriesBackupImport) were removed with that change.
