...
class CpuStatusResponse(BaseModel):
    """Response model for /api/status/cpu endpoint."""
...
class MemoryStatusResponse(BaseModel):
    """Response model for /api/status/memory endpoint."""
...
class LoadStatusResponse(BaseModel):
    """Response model for /api/status/load endpoint."""
...
class PrimaryDriveStatusResponse(BaseModel):
    """Response model for /api/status/drives/primary endpoint."""
...
class PowerStatusResponse(BaseModel):
    """Response model for /api/status/power endpoint."""
