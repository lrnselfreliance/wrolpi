#! /usr/bin/env python3
"""
This module will be the entry-point for your plugin.  The wrolpi.main will expect these basic functions to be here.  Add
...
if __name__ == '__main__':
    # If run directly, we'll make our own parser in the same form that wrolpi.main does
