...
CATALOG = [
    ...
    dict(name='ai/files/search', method='POST', path='/api/ai/files/search', body={'search_str': '{q}', 'limit': 5}),
    dict(name='ai/files/search video', method='POST', path='/api/ai/files/search',
         body={'search_str': '{q}', 'kind': 'video', 'limit': 5}),
    dict(name='ai/files/search archive', method='POST', path='/api/ai/files/search',
         body={'search_str': '{q}', 'kind': 'archive', 'limit': 5}),
    dict(name='ai/files/search doc', method='POST', path='/api/ai/files/search',
         body={'search_str': '{q}', 'kind': 'doc', 'limit': 5}),
    dict(name='ai/zims/search', method='POST', path='/api/ai/zims/search', body={'search_str': '{q}', 'limit': 5}),
    dict(name='ai/files/<video id>', method='GET', path='/api/ai/files/{video_id}', needs='video_id'),
    dict(name='ai/files/<archive id>', method='GET', path='/api/ai/files/{archive_id}', needs='archive_id'),
