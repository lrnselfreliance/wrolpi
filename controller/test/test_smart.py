...
class TestGetSmartStatus:
    """Tests for get_smart_status function."""

    def test_returns_none_when_not_available(self):
        """Should return None when SMART not available."""
        with mock.patch("controller.lib.smart.is_smart_available", return_value=False):
            result = get_smart_status("/dev/sda")
    ...
    def test_returns_device_status(self):
        ...
        with mock.patch("controller.lib.smart.is_smart_available", return_value=True):
            with mock.patch("controller.lib.smart.Device", return_value=mock_device):
                result = get_smart_status("/dev/sda")
