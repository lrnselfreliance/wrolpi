...
function ChannelPage({create, header}) {
    ...
    const channelDownloads = channel !== null ? channel.channel_downloads : null;
                ...
                <FormGroup>
                    <FormField width={16}>
                        <FormInput
                            ...
                            name="url"
                            type="url"
                            disabled={true} // Download URL has moved.
...
export function ChannelDownloadForm({channel_id, afterSave, closeModal, download}) {
    ...
    const handleInputChange = (e, {name, value}) => {
        ...
        if (name === 'url') {
            setUrlValid(validURL(urlValid, value));
        }
    ...
    return <Form onSubmit={handleSubmit}>
        ...
        <Grid columns={2} stackable>
            ...
            <Grid.Row columns={2}>
                <Grid.Column width={2}>
                    <TagsSelector onAdd={(tagName) => setTag(tagName)} limit={1}/>
                </Grid.Column>
                <Grid.Column width={14}>
                    {tag && <TagsGroup tagNames={[tag]}/>}
                </Grid.Column>
            </Grid.Row>
            <Grid.Row columns={1}>
