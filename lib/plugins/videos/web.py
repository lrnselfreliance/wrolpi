...
from lib.common import env, get_pagination_with_generator, create_pagination_dict
from lib.plugins.videos.common import get_downloader_config, get_video_description, get_video_info_json
...
async def index(request):
    ...
    template = env.get_template('lib/plugins/videos/templates/channels.html')
...
async def settings(request):
    ...
    template = env.get_template('lib/plugins/videos/templates/channels_settings.html')
    kwargs = _get_render_kwargs(db,
...
def channel_index(request, link: str = None, offset: int = None, limit: int = None):
    ...
    template = env.get_template('lib/plugins/videos/templates/channel_videos.html')
...
def video_index(request, link: str, hash: str):
    ...
    template = env.get_template('lib/plugins/videos/templates/video.html')
