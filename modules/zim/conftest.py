...
@pytest.fixture
def assert_zim_search(test_client, test_directory):
    from http import HTTPStatus

    def _(search_str: str, zim_id: int, expected: Dict, tag_names: List[str] = [],
        ...
        request, response = test_client.post(f'api/zim/search/{zim_id}', content=json.dumps(content))
