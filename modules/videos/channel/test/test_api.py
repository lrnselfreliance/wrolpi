...
from wrolpi.downloader import download_manager, Download, DownloadResult, DownloadFrequency
...
async def test_channel_download_requires_refresh(
    ...
    with mock.patch('modules.videos.downloader.YDL.extract_info') as mock_extract_info, \
        ...
        mock_extract_info.return_value = {'entries': entries, 'url': download_channel.url, 'uploader': 'some uploader',
